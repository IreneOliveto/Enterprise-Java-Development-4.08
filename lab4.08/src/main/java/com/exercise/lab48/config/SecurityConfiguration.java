package com.exercise.lab48.config;

import com.exercise.lab48.service.security.CustomUserDetailsService;
...
public class SecurityConfiguration {
    ...
    SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
                ...
                .mvcMatchers(HttpMethod.PATCH).hasAnyRole("ADMIN", "CONTRIBUTOR")
